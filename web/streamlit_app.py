...
if not shops:
    ...
    # Render interactive data table using experimental data editor / dataframe
    st.dataframe(
        df,
...
# Important: Streamlit cache mechanism holds session open, ensure it's not conflicted in concurrent use.
# Since it's read-only here, it should be mostly fine. Ideally we use scoped_session or session context managers.
